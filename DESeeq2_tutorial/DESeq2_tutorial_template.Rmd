...
plotPCA(rlog_transformed_dds_subset, intgroup="cell_type", ntop=nrow(rlog_transformed_dds_subset)) + theme(aspect.ratio=1)
...
dds_final <- dds_final[rowSums(assays(dds_final)$counts) > 0, ]
...
```{r}
results_CD8_CD4 <- results(dds_final, contrast = c('cell_type','CD4','CD8'))

results_CD8_CD4

results_CD4_CD8 <- results(dds_final, alpha = 0.05, contrast = c('cell_type','CD4','CD8'))

results_CD4_CD8

summary(results_CD4_CD8)
summary(results_CD8_CD4)

print(summary(results_CD4_CD8), summary(results_CD8_CD4))
```
...
head(shrunkenLFC_dds_results_df)
