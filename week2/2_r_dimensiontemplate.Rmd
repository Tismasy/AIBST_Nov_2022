...
```{r}
pca_iris
#convert standard dev into variance
pca_iris$sdev^2
...
```{r}
ggplot(variance_dataframe, aes(x=pca, y=explained_variance)) +
  geom_col()
...
```{r}
ggplot(umap_iris_dataframe, aes(V1, V2,)) +
  geom_point()
```
