...
VlnPlot(seurat_after_qc, features = c("nFeature_RNA", "nCount_SCT"))
```
...
```{r}
joint.bcs <- intersect(row.names(hto12.htos), colnames(hto12.umis))
...
hto12_object <- FindVariableFeatures(hto12_object, select.method = "vst")
